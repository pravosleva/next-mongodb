...
const MyComponent = memo(
  ({ noHeader, note: initialNote, descriptionRenderer, isTagsNessesary, shouldTitleBeTruncated }: IProps) => {
        ...
        {!!freshNote && !!_id && !noHeader && (
          ...
          >
            ...
            <div className={classes.timeSectionWrapper}>
              <div>Crt: {createTimeNormalized || typeof createTimeNormalized}</div>
              {isDesktop && (
                <Button
                  variant="text"
                  size="small"
